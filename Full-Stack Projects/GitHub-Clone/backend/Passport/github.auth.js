...
passport.use(new GitHubStrategy({
  ...
  async function(accessToken, refreshToken, profile, done) {
    ...
    // signup
    if(!user){ // if user not found in database, create new user
        ...
        done(null, newUser); // return user object to callback
    }
    else{
        // login  // if user already there in database
        done(null, user); // return user object to callback
    }   
  }
));
