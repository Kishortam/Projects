...
const HomeScreen = () => {
  ...
  return (
    ...
    <div className='relative h-screen text-white'>
      ...
      {/* overlay and gradient on hero image */}
      <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32'>
        ...
        <div className='max-w-2xl'>
          ...
          <div className='flex mt-8'>
              ...
              >
							<Play className='size-6 mr-2 fill-black white' />
							Play
						</Link>

						<Link to={`/watch/${trendingContent?.id}`}
							className='bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 rounded flex items-center white'
						>
